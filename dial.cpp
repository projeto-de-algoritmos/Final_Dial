...
public: 
    ...
    void shortestPath(int s,int dest, int W); 
}; 
...
void Graph::shortestPath(int src,int dest, int W) 
{ 
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                // v is before u in the short path
                pred[v] = u;
...
{  
    int V,A,u,v,w; // = 9; 
    srand (time(NULL));
    cout << "insert number of nodes and edge" << endl;
    cin >> V >> A;
    Graph g(V); 
    ...
    cout << endl;
    cout << "insert source and destiny" << endl;
    int src,dest;
    cin >> src >> dest;
    /*
